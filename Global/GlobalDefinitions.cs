...
namespace MarsFramework.Global
{
    class GlobalDefinitions
    {
        ...
        internal static void WaitForElementClickable(IWebDriver driver, string key, string value, int seconds)
        {
        ...
        internal static void WaitForElementVisibility(IWebDriver driver, string key, string value, int seconds)
        {
            try
            {
                if (key == "XPath")
